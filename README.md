...
New features and fixes are released frequently. Check the badge above for the latest version, see what's new in the [changelog](https://bobleesj.github.io/quantem.widget/changelog.html), and run:
